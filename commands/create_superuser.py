...
from auth.infrastructure.repositories.user_repository_impl import UserRepositoryImpl
...
def init_app(app: Flask):
    ...
    @click.option('--password', prompt='Password', hide_input=True, confirmation_prompt=True, help='Super user password')
    def create_superuser(username, email, password):
        UserService(UserRepositoryImpl(), RoleRepositoryImpl()).create_user(username=username, email=email,
